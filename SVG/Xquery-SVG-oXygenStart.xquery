...
declare variable $allCatches := $starwars//name[@person] => distinct-values();
declare variable $distCatches := $starwars//name[@person] ! normalize-space() ! lower-case(.) ! replace(., "'", '') => distinct-values();
...
<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
    ...
    let $countThisCatch := $starwars//Q{}name[@person][normalize-space() ! lower-case(.) ! replace(., "'", '') = $d] => count()
